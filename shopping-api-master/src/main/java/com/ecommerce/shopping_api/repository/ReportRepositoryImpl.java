...
public class ReportRepositoryImpl implements ReportRepository {
    ...
    public List<Shop> getShopByFilters(LocalDate dataInicio, LocalDate dataFim, Float valorMinimo) {
        ...
        sb.append("select s "); sb.append("from shop s ");
        ...
        if (dataFim != null) { query.setParameter("dataFim",dataFim.atTime(23,59));
        }
        if (valorMinimo != null) {
    ...
    public ShopReportDTO getReportByDate(LocalDate dataInicio, LocalDate dataFim) {
        ...
        sb.append("where sp.date >= :dataInicio "); sb.append("and sp.date <= :dataFim ");
